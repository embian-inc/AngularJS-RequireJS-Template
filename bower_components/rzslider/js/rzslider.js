...
define([
    ...
    .factory('RzSlider', ['$timeout', '$document', '$window', 'throttle', function($timeout, $document, $window, throttle)
    {
      ...
      var Slider = function(scope, sliderElem, attributes)
      {
        ...
        /**
         * Always show selection bar reverse
         *
         * @type {boolean}
         */
        this.alwaysShowBarReverse = !!attributes.rzSliderAlwaysShowBarReverse;
        ...
        /**
         * Color of selection bar and pointer
         *
         * @type {string}
         */
        this.selectionColor = attributes.rzSelectionColor;
      ...
      Slider.prototype = {
        ...
        initElemHandles: function()
        {
          ...
          if (this.selectionColor) {
              this.selBar.find(".rz-selection").css("background-color",this.selectionColor);
              this.minH.css("background",this.selectionColor);
              this.maxH.css("background",this.selectionColor);
          }
          // Hide limit labels
          ...
          if(this.range === false && this.alwaysShowBar === false && this.alwaysShowBarReverse === false)
          {
            this.maxH.remove();
            this.selBar.remove();
          }
        ...
        {
          if (this.alwaysShowBarReverse === true) {
              this.setWidth(this.selBar, Math.abs(this.barWidth - this.minH.rzsl));
              this.setLeft(this.selBar, Math.abs(this.minH.rzsl));
            //   this.setLeft(this.selBar, this.barWidth - this.minH.rzsl - this.handleHalfWidth);
          }
          else {
